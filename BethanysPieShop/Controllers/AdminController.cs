...
namespace BethanysPieShop.Controllers
{
    ...
    public class AdminController : Controller
    {
        ...
        public async Task<IActionResult> AddUser(AddUserViewModel addUserViewModel)
        {
            ...
            var user = new IdentityUser { UserName = addUserViewModel.UserName, Email = addUserViewModel.Email };
        ...
        [HttpPost]
        public async Task<IActionResult> DeleteUser(EditUserViewModel editUserViewModel)
        {
            var user = await _userManager.FindByIdAsync(editUserViewModel.Id);
        ...
        //        {
        //            ViewBag.EditAdmin = "Can't edit or delete an admnistrator rol";
        //        }
